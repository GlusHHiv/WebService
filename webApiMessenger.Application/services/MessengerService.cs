...
public class MessengerService
{
    ...
    public async Task<Message> SendMessage(int groupChatId, int senderId, string messageText)
    {
        return await _messageRepository.AddMessage(groupChatId, senderId, messageText);
    }
